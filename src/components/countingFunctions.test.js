...
describe('deadlineFormating', () => {
  test.each`
  time        | startDate                                  |  result
  ${1}        | ${new Date("Sat, 2022-01-01, 11:11")}      |  ${"Термін здавання: 03.01.22 о 11:00"}
  ...
  ${1}        | ${new Date("Fri, 2022-02-11, 09:18")}      |  ${"Термін здавання: 11.02.22 о 11:00"}
  ${15}       | ${new Date("Fri, 2022-02-11, 06:57")}      |  ${"Термін здавання: 14.02.22 о 16:00"}
  ${1.5}      | ${new Date("Fri, 2022-02-11, 21:21")}      |  ${"Термін здавання: 14.02.22 о 11:30"}
  ${1}        | ${new Date("Sat, 2022-02-12, 20:12")}      |  ${"Термін здавання: 14.02.22 о 11:00"}
